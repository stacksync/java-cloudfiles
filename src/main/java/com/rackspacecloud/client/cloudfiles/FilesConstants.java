...
public class FilesConstants
{
    ...
    //MODULE TORRENT
    public static final String X_CHECK_TORRENT_FILEID  = "X-checkTorrentFileId";
    public static final String X_CHECK_TORRENT_VERSION  = "X-checkTorrentVersion";
    public static final String X_CHECK_TORRENT_WORKSPACEID  = "X-checkTorrentWorkSpaceId";
    public static final String X_CHECK_TORRENT_KEYFILE = "X-checkTorrentKeyFile";
    public static final String X_AUTHENTICATION_URL = "X-authenticationURL";
